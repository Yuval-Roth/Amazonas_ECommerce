...
public class ActionsOfAStoreManager {
    ...
    private DefaultPermissionsProfile defaultRegisteredUserPermissionsProfile;
    private DefaultPermissionsProfile guestPermissionsProfile;
    ...
    public void setUp() {
        ...
        StoresController storesController = new StoresController(storeFactory, storeRepository, transactionRepository, productRepository,null);
